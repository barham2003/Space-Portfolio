      ...
      <div className="absolute -left-4 top-3 hidden md:-left-20 lg:block">
        ...
        >
          <motion.div
            ...
            animate={{
              backgroundColor: scrollYProgress.get() > 0 ? "white" : "gray",
              borderColor: scrollYProgress.get() > 0 ? "white" : "gray",
            }}
        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.325" stopColor="gray"></stop>
              <stop offset="1" stopColor="gray" stopOpacity="0"></stop>
            </motion.linearGradient>
          </defs>
        </svg>
      </div>
      <div ref={contentRef} className={cn(childrenClassName)}>
        {children}
      </div>
    </motion.div>
  );
